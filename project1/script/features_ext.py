...
def build_poly_standard(x, degree):
    ...
    Params :
        ...
        - degree : int
    Returns :
        extended x with size N * (1 + D*(degree))
    """
...
def selec_rows_features(x, degree, n_features, n_rows):
    """
        Selects randomly n_features and n_rows from x and computes their monomials and interaction terms.
        params :
            x : array N * D
            degree : int
            n_features : int
